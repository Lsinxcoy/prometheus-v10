...
def create_cli() -> Any:
    ...
    @app.command()
    def init(db_path: str = "data/prometheus_v9pro.db"):
    ...
    def evolve(steps: int = 10, test_path: str | None = None):
        ...
        from prometheus_v9pro import Life
        life = Life()
    ...
    @app.command()
    def search(query: str, limit: int = 10, db_path: str = "data/prometheus_v9pro.db"):
        """Search memory."""
        from prometheus_v9pro.store import SQLiteStore
        store = SQLiteStore(db_path)
    ...
    @app.command()
    def status(db_path: str = "data/prometheus_v9pro.db"):
        """Show system status."""
        from prometheus_v9pro import Life
    ...
    @app.command()
    def dream(db_path: str = "data/prometheus_v9pro.db"):
        """Run dream cycle."""
        from prometheus_v9pro import Life
        life = Life(db_path=db_path)
...
def create_http_app(life=None):
    from prometheus_v9pro.http import create_app
